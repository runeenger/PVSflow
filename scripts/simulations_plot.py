...
for i,stage in enumerate(stages) :
    for j, bandname in enumerate(bandnames) :
        ...
        axs2[i, j].text( -0.9*escale, -0.7*escale, formatminmax%((emin*factor,emax*factor)),fontsize=7)
    ...
    if showtotal :
        ...
        axs2[i, len(bandnames)].text( -0.9*escale, -0.7*escale, formatminmax%((emin*factor,emax*factor)),fontsize=7)
