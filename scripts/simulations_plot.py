...
analysis='disp-d2e-07-l6e-02RandomVeinsWT10'
analysis='disp-d7e-08-l6e-02SMC50WT10new'
...
# variable to plot
variable='Rfit' #'Rfit', 'umax'   , 'pmax', 'amp'

# rescaling for the plotting (change of unit for example)
factor=100    #100,  1e4, 0.1, 1

# max value for the x and y axis in the bubble plot
escale=1    #1, 120e-4  1000 0.12 # value before rescaling with factor

# unit and format when printing the values of the variable
unit='%'    #   ' %''um/s' 'Pa' # unit after rescaling with the factor
formatstr='%.1f'
...
listvariables=['stage','bandname','vessel id','amp','f','h0','Destfit','Rfit','u max (um/s)', 'p max (Pa)']
columnsname=['stage','frequency band name','vessel id','Oscillation amplitude (pc)','Oscillation frequency (Hz)','Thickness (cm)','Effective diffusion coefficient','Enhancement factor R','Peak velocity (um/s)', 'Peak pressure (Pa)']
